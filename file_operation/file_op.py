...
class File_Operation:
    ...
    def load_model(self,filename):
        ...
        try:
            with open(self.model_directory + filename + '/' + filename + '.pkl','rb') as f:
            ...
            self.logger_object.log(self.file_object,'Exception occured in load_model method of the Model_Finder class. Exception message:  ' + str(
                                       e))
